...
In the project directory, there are a number of Java classes defined (com.team1.cpuInfo, com.team1.usbInfo, com.team1.pciInfo) that provide methods to get information about
system devices.  The file com.team1.template.java demonstrates how to use the info classes.
